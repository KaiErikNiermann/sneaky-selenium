"""Navigator webdriver evasion module."""
...
_JS_PATH = Path(__file__).parent / "js" / "navigator.webdriver.js"


def navigator_webdriver(driver: WebDriverProtocol, **kwargs: Any) -> None:
